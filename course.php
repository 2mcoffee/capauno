...
?>
	<div class="container">
		<div class="w-100 shadow p-3 mb-5 bg-body rounded">
			...
			<div class="row">
				<div class="col-sm-12">
					<form class="form" action="./course.php" method="get">
		...
		<div class="row mb-4">
			...
			<div class="col-sm-6 text-right">
				<a class="btn btn-sm btn-outline-primary d-print-none" data-tooltip="tooltip" data-placement="top" title="Listado"  href="./course.php">
		...
		<div class="table-responsive-sm mb-4" id="FilterTable">
			...
			<?php
				...
				require_once('./model/course-data.php');
				...
				while($row = mysqli_fetch_array($search_results)) {
					...
					echo '						<a href="./training.php?id='.$row["Id"].'" class="btn btn-sm btn-outline-primary" data-tooltip="tooltip" data-placement="bottom" title="Cursos"><i class="bi bi-clipboard"></i></a>' . "\n";
					echo '						</td>' . "\n";
					echo '					</tr>' . "\n";
				}
			?>
