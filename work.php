...
?>
	<div class="container">
		<div class="w-100 shadow-sm p-3 mb-5 bg-body rounded">
			<div><div class="icon-holder"><i class="bi bi-wrench-adjustable text-primary"></i></div> <strong>Búsqueda de Empleos</strong></div>
			<div class="p-2"></div>
			<div class="row">
				<div class="col-sm-12">
					<form class="form" action="./work.php" method="get">
		...
		<div class="row mb-4">
			...
			<div class="col-sm-6 text-right">
				<a class="btn btn-sm btn-outline-primary d-print-none" data-tooltip="tooltip" data-placement="top" title="Listado"  href="./work.php">
		...
		<div class="table-responsive-sm mb-4" id="FilterTable">
			...
			<?php
				...
				require_once('./model/work-data.php');

				while($row = mysqli_fetch_array($work_results)) {
					...
					echo '						<td>' . "\n";
					if ($row["Ficha"] != NULL) {
						echo '						<a href="./profile.php?ficha='.$row["Ficha"].'&referencia=3" class="btn btn-sm btn-outline-primary" data-tooltip="tooltip" data-placement="bottom" title="Ficha">' . "\n";
					...
					echo '						<a href="./job.php?id='.$row["Id"].'" class="btn btn-sm btn-outline-primary" data-tooltip="tooltip" data-placement="bottom" title="Empleos"><i class="bi bi-tools"></i></a>' . "\n";
					echo '						</td>' . "\n";
					echo '					</tr>' . "\n";
				}
			?>
