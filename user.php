...
?>
	<div class="container">
		<div class="w-100 shadow-sm p-3 mb-5 bg-body rounded">
			<div><div class="icon-holder"><i class="bi bi-people-fill text-primary"></i></div> <strong>Búsqueda de Perfiles</strong></div>
			<div class="p-2"></div>
			<div class="row">
				<div class="col-sm-12">
		...
		<div class="row mb-4">
			...
			<div class="col-sm-6 text-right">
				<a class="btn btn-sm btn-outline-primary d-print-none" data-tooltip="tooltip" data-placement="top" title="Listado"  href="./user.php">
		...
		<div class="table-responsive-sm mb-4" id="FilterTable">
			...
			<?php
				...
				require_once('./model/user-data.php');
