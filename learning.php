...
?>
	<div class="container">
		<div class="w-100 shadow-sm p-3 mb-5 bg-body rounded">
			<div><div class="icon-holder"><i class="bi bi-mortarboard-fill text-primary"></i></div> <strong>Búsqueda de Estudios</strong></div>
			<div class="p-2"></div>
			<div class="row">
				<div class="col-sm-12">
		...
		<div class="table-responsive-sm mb-4" id="FilterTable">
			...
			<?php
				...
				while($row = mysqli_fetch_array($search_results)) {
					...
					echo '						<td>' . "\n";
					if ($row["Ficha"] != NULL) {
						echo '						<a href="./profile.php?ficha='.$row["Ficha"].'&referencia=4" class="btn btn-sm btn-outline-primary" data-tooltip="tooltip" data-placement="bottom" title="Ficha">' . "\n";
